...
const programaSchema = mongoose.Schema({
    nombre: String,
    politica: { type: mongoose.Schema.Types.ObjectId, ref: 'Politica' }
},
...
const mongoose = require('mongoose');
const Programa = require('./ruta_de_tu_modelo_Programa'); // Asegúrate de ajustar la ruta según la ubicación de tu modelo Programa
